    ...
    try{
      ...
      while($fila = $sql_comando -> fetch(PDO::FETCH_ASSOC))
      {
        ...
        '
            ...
            <td style="text-align: right !important;">'.$fila["SimboloMoneda"].'</td>
            <td style="text-align: right !important;">'.$fila["SimboloMoneda"].' '.$fila["ValorCompra"].'</td>
            <td style="text-align: right !important;">'.$fila["SimboloMoneda"].' '.$fila["IGVCompra"].'</td>
            <td style="text-align: right !important;">'.$fila["SimboloMoneda"].' '.$fila["TotalCompra"].'</td>
            <td> 
