    ...
    <div id="Formulario" class="">
        <div class="box-header with-border">
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-md-3 nvchRUC">
                <div class="form-group">
                  <label>RUC:</label>
                  <input type="text" maxlength="11" minlength="11" class="form-control select2" value="<?php echo $this->nvchRUC; ?>" readonly>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
          ...
          <div class="box-footer clearfix">
              <input type="hidden" id="intIdOrdenCompra" name="intIdOrdenCompra" value="<?php echo $this->intIdOrdenCompra; ?>" />
              <input type="hidden" name="dtmFechaCreacion" value="<?php echo $this->dtmFechaCreacion; ?>" />
              <input type="button" id="" class="btn btn-sm btn-info btn-flat pull-left" value="Cerrar Detalle" onclick="vertab1()">
          </div>              
        <div id="resultadocrud"></div>
      </div>
<?php 
