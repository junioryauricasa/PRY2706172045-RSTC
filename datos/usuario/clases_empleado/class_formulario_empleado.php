      ...
      <div id="Formulario" class="box box-default">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            ...
            <button type="button" id="btn-form-empleado-remove" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
          </div>
        </div>
        <form id="form-empleado" method="POST">
          <div class="box-body">
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row">
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <textarea id="nvchObservacion" class="form-control select2" maxlength="800" name="nvchObservacion" form="form-empleado" rows="6"><?php echo $this->nvchObservacion; ?></textarea>
                  </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <input type="hidden" name="IdComunicacionEmpleado" id="intIdComunicacionEmpleado" value="" />
                </div>
              </div>
              <div class="row">
                <div class="col-md-5">
        ...
        <div class="box-footer clearfix">
            ...
            <?php } ?>
            <input type="hidden" name="intIdEmpleado" id="intIdEmpleado" value="<?php echo $this->intIdEmpleado; ?>" />
            <?php if($funcion == "F"){ ?>
            <input type="submit" id="btn-crear-empleado" class="btn btn-sm btn-info btn-flat pull-left" value="Crear Empleado">
