  ...
  ?>  
      <div id="Formulario" class="box box-default">
        <div class="box-header with-border">
          <?php if($funcion == "F"){ ?>
          <h3 class="box-title">Nueva Moneda Tributaria</h3>
          <?php } else if($funcion == "M") {?>
          <h3 class="box-title">Editar Moneda Tributaria</h3>
          <?php } ?>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            <button type="button" id="btn-form-moneda-tributaria-remove" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
          </div>
        </div>
        <form id="form-moneda-tributaria" method="POST">
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-3">
                <div id="dcmCambio1" class="form-group">
                  <label>Valor Monetario EstadoUnidense:</label>
                  <input type="text" id="dcmCambio1" name="dcmCambio1" class="form-control select2" placeholder="Ingrese Valor EstadoUnidense" 
              ...
              <div class="col-md-3">
                <div id="dcmCambio2Group" class="form-group">
                  ...
                  <input type="text" id="dcmCambio2" name="dcmCambio2" class="form-control select2" placeholder="Ingrese RUC" 
        ...
        <div class="box-footer clearfix">
            ...
            <?php if($funcion == "F"){ ?>
            <input type="button" id="btn-crear-moneda-tributaria" class="btn btn-sm btn-info btn-flat pull-left" value="Crear MonedaTributaria">
            <input type="reset" class="btn btn-sm btn-danger btn-flat pull-left" value="Limpiar" style="margin: 0px 5px">
            <?php } else if($funcion == "M") { ?>
            <input type="button" id="btn-editar-moneda-tributaria" class="btn btn-sm btn-warning btn-flat pull-left" value="Editar MonedaTributaria"> 
            <input type="reset" class="btn btn-sm btn-danger btn-flat pull-left" value="Limpiar" style="margin: 0px 5px">
            <?php } ?>
        </div>              
        </form>
