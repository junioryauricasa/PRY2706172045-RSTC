  ...
  ?>  
      <div id="Formulario" class="box box-default">
        ...
        <div class="box-footer clearfix">
            ...
            <?php if($funcion == "F"){ ?>
            <input type="button" id="btn-crear-moneda-comercial" class="btn btn-sm btn-info btn-flat pull-left" value="Crear MonedaComercial">
            <input type="reset" class="btn btn-sm btn-danger btn-flat pull-left" value="Limpiar" style="margin: 0px 5px">
            <?php } else if($funcion == "M") { ?>
            <input type="button" id="btn-editar-moneda-comercial" class="btn btn-sm btn-warning btn-flat pull-left" value="Editar MonedaComercial"> 
            <input type="reset" class="btn btn-sm btn-danger btn-flat pull-left" value="Limpiar" style="margin: 0px 5px">
            <?php } ?>
        </div>              
        </form>
