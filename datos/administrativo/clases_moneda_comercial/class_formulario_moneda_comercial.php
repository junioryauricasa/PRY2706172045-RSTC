  ...
  ?>  
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">
              <?php if($funcion == "F"){ ?>
                  Nueva Moneda Comercial
              <?php } else if($funcion == "M") {?>
                  Editar Moneda Comercial
              <?php } ?>
            </h4>
        </div>
        <div class="modal-body">
            <div id="Formulario" class="">
              ...
              <div class="box-footer">
                  ...
                  <!-- btn cerrar -->
                  <button type="button" class="btn btn-sm btn-default btn-flat pull-left" id="btn-form-moneda-comercial-remove" data-dismiss="modal">Cerrar Formulario</button>
              </div>              
              </form>
