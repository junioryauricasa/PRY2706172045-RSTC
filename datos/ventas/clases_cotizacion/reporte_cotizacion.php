...
<head>
 ...
 content="text/html; charset=utf-8">
  <title>Reporte_Cotizacion</title>
  <style>
    table#tabladetalle {
  ...
  <tbody>
    <tr>
      <td style="width: 246px;" rowspan="2">
        ...
        <span style="font-family: Brush Script MT;">¡18 Años Liderando el Sector Agrícola!</span>
      </td>
      ...
      <td style="width: 120px;">
        <img style="width: 130px; height: 42px;" alt="logo_resteco_construction" src="../../imagenes/logo_resteco_case_construction.png">
      </td>
    </tr>
    <tr>
      <td style="width: 120px;">
...
<table id="tabladetalle" style="text-align: left; width: 683px; height: 130px;" cellpadding="3" cellspacing="1">
  <tbody>
    ...
    <tr id="tercerdetalle">
      <td id="celdainfo"
 style="vertical-align: top; width: 179px;" colspan="5"
 rowspan="3"><small><small><span
 style="font-family: Arial;">* La fecha de entrega será de acuerdo a los ítems disponibles en stock, en caso de importación la entrega será en 30 días calendario.</span></small></small></td>
      <td class="celdatotales" colspan="2" style="font-weight: bold; text-align: right; font-family: Arial; width: 50px;">
        <small><small>SUBTOTAL</small></small>
      </td>
...
<br>
<table style="text-align: left; width: 702px;"
 border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="text-align: center; width: 109px;">
        <img style="width: 63px; height: 28px;" alt="" src="../../imagenes/logo_resteco_newholland.png">
      </td>
      <td style="text-align: center; width: 106px;">
        <img style="width: 56px; height: 13px;" alt="" src="../../imagenes/logo_resteco_ford.png">
      </td>
      <td style="text-align: center; width: 90px;">
        <img style="width: 30px; height: 33px;" alt="" src="../../imagenes/logo_resteco_massey.png">
      </td>
      <td style="text-align: center; width: 138px;">
        <img style="width: 59px; height: 22px;" alt="" src="../../imagenes/logo_resteco_john.png">
      </td>
      <td style="text-align: center; width: 131px;">
        <img style="width: 92px; height: 35px;" alt="" src="../../imagenes/logo_resteco_lapina.png">
      </td>
      <td style="text-align: center; width: 110px;">
        <img style="width: 84px; height: 55px;" alt="" src="../../imagenes/logo_resteco_jumil.png">
      </td>
    </tr>
  </tbody>
</table>
