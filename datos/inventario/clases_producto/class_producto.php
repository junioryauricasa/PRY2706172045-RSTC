        ...
        if($fila["nvchCodigo"]!=""){
          ...
          '
              ...
              <td align="right" data-th="Opciones"> 
                <button type="submit" id="'.$fila["intIdProducto"].'" class="btn btn-xs btn-warning btn-mostrar-producto" onclick="showmodalcreateproduct();" data-toggle="tooltip" title="Editar">
