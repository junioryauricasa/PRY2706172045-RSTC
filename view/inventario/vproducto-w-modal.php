              ...
              <div class="box-footer clearfix">
                <div class="row">
                  <div class="col-md-5">  
                    ...
                    <button type="button" class="btn btn-sm btn-danger btn-flat" onclick="showmodalcreateproduct()">Agregar Nuevo Producto</button>
          
                    <!-- script for for New Product -->
                    <script type="text/javascript">
                          function showmodalcreateproduct(){
                            $('#modal-showmodalcreateproduct').modal('show');
                          }
                    </script>
                  
                    <!-- Modal for New Product-->
                    <div class="modal modal-default fade" id="modal-showmodalcreateproduct" data-backdrop="static">
                      <div class="modal-dialog" style=" width: 95%">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title"><i class="fa fa-book"></i>
                                Registro Nuevo Producto <b><span id="CodigoProducto"></span></b>
                            </h4>
                          </div>
