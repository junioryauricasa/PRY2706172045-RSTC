		      ...
		      <div class="tab-pane active" id="tab_1">
			    ...
			    <section class="content">
			      ...
			      <div class="">
                    ...
                    <!-- Modal for New Product-->
                    <div class="modal modal-default fade" id="modal-showmodalcreateproduct" data-backdrop="static" onload="">
                ...
                <div class="box-body">
                  <div class="row">
                      ...
                      <div class="col-lg-3 col-md-6">
                          ...
                          <input type="submit" id="btn-editar-producto" class="btn btn-sm btn-warning btn-flat pull-left hidden" value="Editar Producto">
                          <input type="reset" class="btn btn-sm btn-danger btn-flat pull-left hidden" id="btn-limpiarformproducto" value="Limpiar" style="margin: 0px 5px">
                      </div>
