        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <select id="intIdTipoProducto" onchange="DescripcionProducto(this.value)" name="intIdTipoProducto" class="form-control select2" >
                  <?php try{
        ...
        <div class="col-lg-3 col-md-3">
            ...
            <div class="col-md-12">
              <div id="dcmDescuentoVenta2Group" class="form-group">
                ...
                placeholder="Descuento 2" value="7" 
            ...
            <div class="col-md-12">
              <div id="dcmDescuentoVenta3Group" class="form-group">
                ...
                placeholder="Descuento 3" value="15" 
