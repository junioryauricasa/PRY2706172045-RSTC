...
$(document).on('click', '.btn-mostrar-cotizacion', function(){
	  ...
	  $.ajax({
	   ...
	   success:function(datos)
	   {
	   	...
	   	$("#formulario-crud").html(datos);
	   	goToBox("#Formulario");
	   	$("#tipo-cotizacion").val($("#intIdTipoCotizacion").val());
	   	*/
	   	MostrarSeleccionCotizacion($("#intIdTipoCotizacion").val());
	  ...
	  $.ajax({
	   ...
	   success:function(datos)
	   {
	   	if (datos=="ok") {
	   		...
	   		/*
	   		$("#lista-cotizacion").val($("#tipo-cotizacion").val());
	   		AccionCabecerasTablaCotizacion(intIdTipoCotizacion);
