<?php include('_include/rstheader.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Ejemplo de CRUD
        <small>Ejemplo de CRUD ajax</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <table class="table table-hover table-condensed">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>iPhone 6 Plus</td>
                    <td><span class="label label-danger">Delivered</span></td>c
                    <td>
        ...
        <div class="box-footer clearfix">
          <a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Reportes Completo de Usuarios</a>
