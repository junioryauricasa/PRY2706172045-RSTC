...
if (isset($_POST['regNuevoProducto'])) {
    $intIdUsuario = $_POST['idusuario'];
    $intIdProveedor = $_POST['idproveedor'];
    $dtmFechaCreacion = $_POST['fechacreacion'];
    ...
    $sql = "INSERT INTO tb_guia_interna_entrada (intIdUsuario, intIdProveedor, dtmFechaCreacion) VALUES ($intIdUsuario, $intIdProveedor, '$dtmFechaCreacion')";

    if (mysqli_query($con, $sql)) {
        echo "Registro creado";
          $intIdUsuario = null;
          $intIdProveedor = null;
          $dtmFechaCreacion = null;
    } else {
...
?>
    ...
    <script>
        function refresh_div() {
            jQuery.ajax({
                url:'ajax/selectAllGuiaInternaEntrada.php',
                type:'POST',
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Generación de Guías Internas de Producto
    ...
    <section class="content">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Registro de Guías Internas de Entrada de Producto</h3>
        ...
        <div class="box-footer clearfix">
          ...
          <button type="button" class="btn btn-sm btn-info btn-flat pull-left" data-toggle="modal" data-target="#modalcust">Generar Guía Interna de Entrada de Producto</button>
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Registro de Guía Interna de Entrada de Producto</h3>
            ...
            <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="nombre" class="form-control select2" placeholder="Ingrese texto">
