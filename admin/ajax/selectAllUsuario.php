...
{  
    ...
    $sql = "SELECT * FROM tb_usuario ORDER BY intUserId DESC LIMIT 10 ";  
    ...
    <tr>  
        ...
        <td> 
          ...
          <input type="submit" class="btn btn-xs btn-danger btnedit" onclick="pregunta('.$row["intUserId"].');" value="Eliminar">
        </td>  
    </tr>  
    ';  
    }  
